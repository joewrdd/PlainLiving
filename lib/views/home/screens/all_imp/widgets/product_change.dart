...
class ChangeProductName extends StatelessWidget {
  const ChangeProductName({super.key});
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              'For easier understanding, use a product name you remember and can identify easily.',
