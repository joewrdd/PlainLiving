...
class ChangeResPrice extends StatelessWidget {
  const ChangeResPrice({super.key});
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              'Enter the new amount for the record, in dollars.',
            ...
            Form(
              child: Column(
                children: [
                  TextFormField(
                    validator:
                        (value) => Validator.validateEmptyText('Amount', value),
                    expands: false,
